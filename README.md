...
```
ds_antigravity/
├── notebook_1.ipynb          # Main analysis notebook (Generated)
...
2. Ensure `historical_data.csv` and `fear_greed_index.csv` are in the expected directory (parent directory or as configured).
3. Run all cells.
